...
function DesignPostersContent() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "10px", alignItems: "flex-start", width: "1240px" }}>
      ...
      <div data-name="Project Carousel" style={{ height: "583px", overflowX: "auto", overflowY: "hidden", position: "relative", width: "100%", flexShrink: 0 }}>
        <div style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", top: "523px", width: "410px", height: "23px" }}>
          <img alt="" style={{ position: "absolute", display: "block", inset: 0, maxWidth: "none", width: "100%", height: "100%" }} src={imgFrame105} />
        </div>
        <div style={{
          position: "absolute", left: "50%", top: "50%",
          transform: "translate(-50%, -50%)",
          display: "flex", gap: "114px", alignItems: "center",
        }}>
          {carouselImages.map(({ src, w }, i) => (
            <div key={i} style={{ height: "410px", position: "relative", flexShrink: 0, width: `${w}px` }}>
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: dark, position: "relative", width: "1440px", fontFamily: mono }}>
        ...
        {/* ── CUSTOM_CODE_BLOCK_01 placeholder ── */}
        <div data-name="CUSTOM_CODE_BLOCK_01" style={{ position: "absolute", height: "1005px", left: 0, top: 0, width: "1440px" }} />
        ...
        <div style={{ paddingTop: "1498px" }}>
          ...
          <div style={{ position: "relative", height: "363px", paddingLeft: "80px", paddingBottom: "100px" }}>
            <div style={{ position: "relative", height: "363px", width: "1280px" }}>
              {/* CUSTOM_CODE_BLOCK_02 placeholder */}
              <div data-name="CUSTOM_CODE_BLOCK_02" style={{ position: "absolute", height: "363px", left: 0, top: 0, width: "665px" }} />
              {/* reels_slot */}
              <div data-name="reels_slot" style={{ position: "absolute", display: "flex", gap: "25px", alignItems: "center", left: "729px", top: "48px" }}>
                {[0, 1, 2].map(i => (
                  <div key={i} style={{ height: "266px", position: "relative", flexShrink: 0, width: "167px" }}>
                    <img alt="" style={coverImg} src={imgReels1} />
                  </div>
                ))}
              </div>
